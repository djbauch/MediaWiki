...
CREATE TABLE watchlist2 (
  ...
  wl_title varchar(255) COLLATE SQL_Latin1_General_CP1_CS_AS NOT NULL DEFAULT '',
  CONSTRAINT /*$wgDBprefix*/watchlist2_pk PRIMARY KEY (wl_user, wl_namespace, wl_title)
) /*$wgDBTableOptions*/;
